...
This change makes the limitation and the need for future validation clear already at the abstract level (Abstract, Conclusions).
...
Specifically, the Conclusions now highlight that, if confirmed in future multi-center studies, the proposed cross-cancer transfer learning approach could be integrated into EHR-based triage and clinical decision support workflows to flag patients at elevated gastric cancer risk for timely endoscopy and specialist referral (Abstract, Conclusions).
