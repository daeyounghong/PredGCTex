...
We developed a cross-cancer transfer learning framework (TransferGC) on structured EHR data from the MIMIC-IV database, \textcolor{red}{including 508 GC cases in the target cohort}, that pretrains on non-gastric gastrointestinal/hepatopancreatobiliary cancers (colorectal, esophageal, liver, pancreatic) and then adapts to GC using only structured variables. We compared transfer variants against strong non-transfer baselines (logistic regression, XGBoost, architecturally matched multilayer perceptron), with AUROC and average precision (AP) as primary endpoints and F1 and sensitivity/specificity as secondary endpoints.
\textbf{Results:}
...
LR & $0.812${\color{red}$\pm0.002$ (0.759--0.862)} & 0.518 & 0.707 & 0.755 & 0.578 \\
XGB & $0.808${\color{red}$\pm0.010$ (0.760--0.851)} & 0.549 & 0.692 & 0.737 & 0.556 \\
MLP & $0.830${\color{red}$\pm0.006$ (0.780--0.874)} & 0.603 & 0.782 & 0.739 & 0.609 \\
Transfer & $0.854${\color{red}$\pm0.007$ (0.811--0.893)} & 0.600 & 0.768 & 0.786 & 0.636 \\
\bottomrule
\end{tabularx}
%\end{adjustwidth}
\end{table}
...
\begin{figure}[htbp]
    ...
    \caption{{\color{red}Reliability diagram showing observed GC incidence versus mean predicted probability. 
...
%\midrule
CC & $0.841${\color{red}$\pm0.006$} & 0.568 & 0.792 & 0.763 & 0.632  \\
PC & $0.838${\color{red}$\pm0.005$} & 0.572 & 0.758 & 0.743 & 0.599 \\
LC & $0.835${\color{red}$\pm0.007$} & 0.544 & 0.767 & 0.745 & 0.605 \\
EC & $0.828${\color{red}$\pm0.005$} & 0.578 & 0.705 & 0.779 & 0.594 \\
CC+EC+LC+PC & $0.854${\color{red}$\pm0.007$} & 0.600 & 0.768 & 0.786 & 0.636 \\
\bottomrule
\end{tabularx}
\end{table}
...
{\color{red}we demonstrated that cross-cancer transfer learning can stabilize GC risk
