...
This entire procedure was repeated 10 times with different data splits, which influence aspects such as parameter initialization and mini-batch sampling, potentially leading to variability in the training process. 
...
\newcommand{\oldDir}{old/tex_and_figs-004}
...
%\midrule
%LR & 0.899 & 0.737 & 0.809 & 0.805 & 0.677 \\
%XGB & 0.894 & 0.731 & 0.845 & 0.824 & 0.713 \\
%MLP & 0.906 & 0.766 & 0.847 & 0.788 & 0.683 \\
%Transfer & 0.920 & 0.780 & 0.893 & 0.790 & 0.709 \\
%\bottomrule
%\end{tabular}
